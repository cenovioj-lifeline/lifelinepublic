                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="min-w-[250px]">Lifeline Name</TableHead>
                      <TableHead className="min-w-[200px]">Collection</TableHead>
                      <TableHead className="text-right w-[120px]"># Events / # Pics</TableHead>
                      <TableHead className="text-right w-[100px]">% with Pics</TableHead>
                      <TableHead className="text-right w-[130px]"># Events / # Locked</TableHead>
                      <TableHead className="text-right w-[100px]">% Locked</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {filteredLifelines?.map((lifeline) => {
                      const picsPercentage = lifeline.total_events > 0 
                        ? Math.round((lifeline.events_with_pics / lifeline.total_events) * 100)
                        : 0;
                      const lockedPercentage = lifeline.total_events > 0 
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="text-right">{picsPercentage}%</TableCell>
                          <TableCell className="text-right">
                            {lifeline.total_events} / {lifeline.events_with_locked}
                          </TableCell>
                          <TableCell className="text-right">{lockedPercentage}%</TableCell>
                        </TableRow>
                      );
                    })}
                  </TableBody>
