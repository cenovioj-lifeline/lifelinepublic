    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select(`
          ...
          profiles!inner(
            *,
            avatar_image:media_assets!profiles_avatar_image_id_fkey(url, alt_text, position_x, position_y, scale, card_position_x, card_position_y, card_scale, extended_data)
          )
        `)
